...
pfleet1.generate_report(output_html="models/geometric_controls.html")

## modelo Geometric no controls
...
pfleet2.generate_report(output_html="models/geometric_no_controls.html")

## modelo Geometric with organic vars and no controls
...
pfleet3.generate_report(output_html="models/geometric_organic.html")

## modelo Geometric with organic vars and controls
...
pfleet4.generate_report(output_html="models/geometric_organic_controls.html")
